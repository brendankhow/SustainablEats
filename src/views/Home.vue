    ...
    <section id = "leaderboard">
      <div class = "container">
        ...
        <div class = "row mt-5 justify-content-center">
          ...
          <div class = "col-md-4"> <!-- Split each card to take up 4 spaces each; 3 cards in a row -->
            <div class = "card ms-5 box-shadow bg-light">
              <img class = "card-img-top" src = "../assets/math_cat.jpg" style="height: 300px; width: 100%; display: block">
              <div class = "card-body">
                  <h3  class = "card-title">Math_Cat</h3>
                  <h3 class = "card-text" style = "display: inline-block">50</h3>
          ...
          <div class = "col-md-4">
            <div class = "card ms-5 box-shadow bg-light">
              <img class = "card-img-top" src = "../assets/duck.jpg" style="height: 300px; width: 100%; display: block">
              <div class = "card-body">
                <!--<h3  class = "card-title" style = "display: inline-block; margin-right: 10px;">Math_Cat</h3>-->
                <h3  class = "card-title">Math_Cat</h3>
                <h3 class = "card-text" style = "display: inline-block">50</h3>
                <img class = "mx-2" src = "../assets/coin.png" style="height: 75px; width: 25%; display: inline;">
              </div>
          ...
          <div class = "col-md-4">
            <div class = "card ms-5 box-shadow bg-light">
              <img class = "card-img-top" src = "../assets/habibi_penguin.jpg" style="height: 300px; width: 100%; display: block">
              <div class = "card-body">
                <h3  class = "card-title">Math_Cat</h3>
                <h3 class = "card-text" style = "display: inline-block">50</h3>
                <img class = "mx-2" src = "../assets/coin.png" style="height: 75px; width: 25%; display: inline;">
    ...
    getDocs(usersCollection)
      .then((snapshot) =>{
        ...
        snapshot.docs.forEach((doc) => {
          books.push({... doc.data()}) // ... = takes this new data and spread into the new objects 
        })
        console.log(books)
    })
    .catch(err =>{
