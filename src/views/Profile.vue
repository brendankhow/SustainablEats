...
<div class="user_chosen_content">
    <div class="album py-5">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-auto g-3" id="albumCards" v-html="card">
                        ...
                        `<div class="col" style="max-width: 300px;">
                            <div class="card">
                                ...
                                <div style="max-height: 250px; overflow: hidden;">
                                    <img src="${recipe_image}" class="card-img-top" alt="Image">
                                </div>
                                <div class="card-body">
                                    <div class="row pb-2">
                                        <div class="col">
                                            <h5 class="card-title" style='text-align:left;overflow:auto;'>${recipe_name}</h5>
                                        </div>
                                    </div>
