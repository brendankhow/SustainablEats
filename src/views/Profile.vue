...
<div class="user_chosen_content">
    <div class="album py-5">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-auto g-3" id="albumCards" v-for="card in cards" v-if="cards">
    ...
    onAuthStateChanged(auth, async (user) => { // add async here
        ...
        if(user){
            ...
            if(docSnap.exists()){
                ...
                this.cards = this.showcontent(this.content);
            }else{
