<template>
        ...
        <div class = "testimonial-box-container">
          ...
          <div class = "testimonial-box">
            ...
            <div class = "client-comment">
              <p>Brendan Khow handsome la sia</p> <!-- Do for-in loop here to retrieve user reviews-->
            </div>    
  ...
  import { getFirestore, doc, getDoc, addDoc, updateDoc, setDoc, arrayUnion } from 'firebase/firestore';
      ...
      if (user){
        ...
        try{
          await updateDoc(recipeRef, {
            ...
            reviews: arrayUnion({ userID, review: userReview.value })
          })
